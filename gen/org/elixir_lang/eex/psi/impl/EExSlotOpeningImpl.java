...
public class EExSlotOpeningImpl extends ASTWrapperPsiElement implements EExSlotOpening {

  public EExSlotOpeningImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EExVisitor visitor) {
    visitor.visitSlotOpening(this);
  }
